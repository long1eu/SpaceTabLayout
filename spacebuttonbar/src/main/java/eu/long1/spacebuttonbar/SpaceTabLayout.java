...
public class SpaceTabLayout extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setTabColor(@ColorInt int backgroundColor) {
        ...
        Drawable image = AppCompatResources.getDrawable(context, R.drawable.background);
        Drawable image2 = AppCompatResources.getDrawable(context, R.drawable.background2);
